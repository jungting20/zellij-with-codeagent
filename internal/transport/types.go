...
type StartAgentRequest struct {
	...
	ReuseDirectoryTab  bool     `json:"reuse_directory_tab,omitempty"`
...
type FocusNextAgentRequest struct {
	...
	UnpinnedOnly       bool   `json:"unpinned_only,omitempty"`
}
...
func (req StartAgentRequest) ToCodingAgent() codingagent.StartAgentRequest {
	return codingagent.StartAgentRequest{
		NewPane:             req.NewPane,
		ReuseDirectoryTab:   req.ReuseDirectoryTab,
