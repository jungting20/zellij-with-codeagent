...
func ErrorFor(err error) (APIError, int) {
	...
	case errors.Is(err, rt.ErrMissingPaneID), errors.Is(err, rt.ErrInvalidExecutionPlan), errors.Is(err, rt.ErrInvalidMessage), errors.Is(err, rt.ErrInvalidPaneTarget):
